...
- 当前状态：H0 工程基线、主题、目标模块目录和空壳首页已建立；HarmonyOS 图标已与桌面端同源，H1 已声明网络 POC 所需最小权限，首页已展示 POC 状态并接入真实 PasteButton、pasteboard 纯文本读取、手动 IP WebSocket 连接和 Desktop ↔ Harmony 临时文本收发。
