...
- D0 工程基线已建立，桌面 UI 已拆出 TypeScript API / store / component 基线；D1 剪贴板 POC 已开始，当前完成文本边界、手动读写系统剪贴板、Win32 剪贴板事件监听、回环抑制核心逻辑、WebSocket POC server 骨架和 Desktop ↔ Harmony 临时文本消息。
- 目标平台：Windows 10/11。
